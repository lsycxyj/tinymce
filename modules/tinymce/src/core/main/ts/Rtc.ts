...
interface RtcAdaptor {
  ...
  formatter: {
    ...
    formatChanged: (registeredFormatListeners: Cell<RegisteredFormats>, formats: string, callback: FormatChangeCallback, similar?: boolean, vars?: Record<string, string>) => UnbindFormatChanged;
  };
  editor: {
...
export const formatChanged = (editor: Editor, registeredFormatListeners: Cell<RegisteredFormats>, formats: string, callback: FormatChangeCallback, similar: boolean = false, vars: Record<string, string> = {}): UnbindFormatChanged =>
