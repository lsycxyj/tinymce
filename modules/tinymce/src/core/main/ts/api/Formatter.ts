...
interface Formatter extends FormatRegistry {
  ...
  formatChanged: (names: string, callback: FormatChanged.FormatChangeCallback, similar?: boolean, vars?: Record<string, string>) => { unbind: () => void };
...
const Formatter = (editor: Editor): Formatter => {
  ...
  return {
     ...
     */
    formatChanged: (formats: string, callback: FormatChanged.FormatChangeCallback, similar?: boolean, vars?: Record<string, string>) => Rtc.formatChanged(editor, formatChangeState, formats, callback, similar, vars),
